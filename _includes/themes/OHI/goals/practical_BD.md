...
[**U.S. West Coast 2014**](http://ohi-science.org/assessment/US-West-Coast) | The model description and reference point were the same as Global 2012, with regional data available for threat categories. | The same reference point was used as the Global model | This followed the Global model, but used local data. This study did not weigh by area.
[**Israel 2014**](http://ohi-science.org/assessment/Israel) | See Global 2012 | See Global 2012. 
